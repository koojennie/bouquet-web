...
<body class="body-fixed">
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    <div class="main-navigation">
                        ...
                        <nav class="header-menu" id="navbarBouquet">
    ...
    <div id="viewport">
        <div data-bs-spy="scroll" data-bs-target="#navbarBouquet" data-bs-smooth-scroll="true" class="scrollspy-example" tabindex="0">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="banner-text">
                                        ...
                                        <p>Discover the enchanting elegance of our floral creations with a special
                                            prices at our bouquet shop, where every arrangement is a masterpiece
                                            designed to bring beauty and joy to your cherished moments.</p>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="banner-img-text mt-4 m-auto">
                                        ...
                                        <p>delicately arranged and bursting with vibrant hues, whispers the silent
                                            poetry of nature's splendor, capturing the essence of fleeting beauty and
                                            timeless grace.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="sec-title text-center mb-5">
                                    ...
                                    <p>Bloom & Bliss was established in 2020. specializes in crafting beautiful bouquets
                                        of real flowers to celebrate everyones happy moments. From seasonal
                                        arrangements,
                                        cup flowers, hand bouquets, table centerpieces, standing flowers to full event
                                        decorations
                                        – our dedicated team is here to meet all your floral needs. Send the finest
                                        flower bouquet to
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="sec-title text-center mb-5">
                                        ...
                                        <h2 class="h2-title">choose your own, <span>give it to your loved ones</span>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="menu-list-row">
                                <div class="row g-xxl-5 bydefault_show" id="menu-dish">
                                    ...
                                    <!-- untuk bunga ke-4 -->
                                    <div class="col-lg-4 col-sm-6 dish-box-wp graduation" data-cat="graduation"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="testimonials-box">
                                                ...
                                                <div class="testimonials-box-text">
                                                    ...
                                                    <p>It would be nice to see the final bouquet in delivery
                                        ...
                                        <div class="col-sm-6">
                                            <div class="testimonials-box">
                                                ...
                                                <div class="testimonials-box-text">
                                                    ...
                                                    <p>Everything is perfect, easy, hassle-free, and beautiful bouquet!
                                                        Very happy.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="testimonials-box">
                                                ...
                                                <div class="testimonials-box-text">
                                                    ...
                                                    <p>The flowers were lovely, fresh and delivered on time with no
                                                        hassle.</p>
                                                </div>
                                            </div>
                                        </div>
